...
class FavoriteAd: UIViewController,
...
//        }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier(myCellID, forIndexPath: indexPath) as! FavoritesCell
//        if currentList == checkList.Mylist || currentList == checkList.Browse{
...
//        if currentList == checkList.Favorite{
                    ...
                    singleAdVC.singleAdID = (classifClass[FAV_AD_POINTER]?.objectId as String?)!
                    singleAdVC.selfobject = classifClass[FAV_AD_POINTER] as! PFObject
        
        singleAdVC.favFlag = true//this means checked item is your favorite ad.
            //return
//        }
...
//    }
    ...
    func favoriteCell(myCell: FavoritesCell, indexPath: NSIndexPath) -> FavoritesCell{
