...
class BrowseAd: UIViewController,
...
//        }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier(myCellID, forIndexPath: indexPath) as! BrowseAdCell
//        if currentList == checkList.Mylist || currentList == checkList.Browse{
...
//        }
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        var currentCell = tableView.cellForRowAtIndexPath(indexPath) as! BrowseAdCell
...
//        else { //Mylisting Or Browse
        ...
        if currentCell.checkFavoriteBt.tag % 2 == 0{
            singleAdVC.favFlag = true
        }else{
            singleAdVC.favFlag = false
        }
//        }
    ...
    func myListingCell(myCell: BrowseAdCell, indexPath: NSIndexPath) -> BrowseAdCell{
        // SHOW ALL YOUR ADS
        var classifClass = PFObject(className: CLASSIF_CLASS_NAME)
        classifClass = classifArray[indexPath.row] as! PFObject
        ...
        if let label = myCell.priceLabel{
            label.text = "$\(classifClass[CLASSIF_PRICE] as! String)"
        }
...
//        myCell.priceLabel.text = "\(adPointer[CLASSIF_PRICE]!)"
//        
//        // Get image
...
//    }
    ...
    func menuButtonClicked(index: Int32) {
        ...
        else if index == 0{//--Pin Screen ??? i donot know it yet, why?//Oh, yes. It's "My Listing"
            if currentList == checkList.Mylist{
                return
            }
            //refresh
    ...
    @IBAction func filterBtClicked(sender: AnyObject) {
        var filterVC = self.storyboard?.instantiateViewControllerWithIdentifier("FilterID") as! Filter
